...
// CODE HERE
const evenNumbers = mixedNumbers.filter((number, index) => mixedNumbers[index] % 2 === 0)
...
// CODE HERE
const bobsTotal = purchases.filter((e) => e.owner === "Bob").reduce((acc, cur,) => acc + cur.price, 0)
